...
create_event_function = {
    ...
    "parameters": {
        ...
        "properties": {
            ...
            "start_datetime": {
                "type": "string",
                "description": "The start date and time of the event in ISO format (e.g., '2024-07-29T15:00:00').",
            },
            "end_datetime": {
                "type": "string",
                "description": "The end date and time of the event in ISO format (e.g., '2024-07-29T16:00:00').",
            },
        },
